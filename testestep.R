...
#/usr/local/spark/ec2/spark-ec2 -i ~/sparkcluster.pem -k sparkcluster --instance-type=c3.4xlarge --spot-price=0.4 --region=us-east-1 --zone=us-east-1e -s 19 -a ami-0a613c62 launch vanillaspark
